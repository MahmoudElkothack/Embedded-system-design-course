...
void setup() {
  ...
  pinMode(13,OUTPUT); //used for Debugging Only
  pinMode(12,OUTPUT); //used for Debugging Only
  pinMode(4,OUTPUT); //used for Debugging Only
}
...
void loop() {
  ...
  while(millis() - tick_time >= 50 ){
   ...
   // super_ClockAlarm->evt.sig =TICK_SIG;
